...
### Skill areas
 * Unix/Linux systems administration (10 years / advanced)
 * Infrastructure automation (2 years / proficient)
 * Application deployment and support (6 years / advanced)
 ...
 * Coordinates with various software development teams for continuous integration, rapid deployment, performance monitoring and tuning, and application support.
 * Develops and maintains tools for application deployment, monitoring, and performance tuning.
 ...
 * Writes Nagios plugins and scripts for a monitoring dashboard. The dashboard, used by analysts for a critical business application, provides a single interface for tracking message workflows across various platforms.
...
#### [Accenture, Inc.](http://www.accenture.com)
...
#### [Asian Development Bank](http://www.adb.org) (under Cytronics, Inc.)
...
#### [National Irrigation Administration](http://www.nia.gov.ph)
