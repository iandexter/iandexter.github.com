...
* Ansible, Puppet (1/basic)
* Nagios, NetCool (5/advanced)
* Apache, Tomcat, Squid (10/advanced)
* Postfix, Sendmail, Courier, Dovecot, Procmail (10/advanced)
* MySQL, PostgreSQL, Sybase, Oracle Database (5/proficient)
...
* Sun Java Identity Management Suite (2/proficient)

#### Web and content development
* Drupal, WordPress (5/proficient)
* TWiki, MediaWiki, Dokuwiki (5/proficient)
...
* Develops and maintain tools for application deployment, monitoring, and performance tuning.
