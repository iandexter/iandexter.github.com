...
\hypersetup{
  ...
  pdfkeywords = {Unix/Linux systems administration, Infrastructure automation, Application deployment and support, Network design, development and administration, Web design, development and management, Identity management, Red Hat Enterprise Linux, CentOS, Fedora, SuSE Linux Enterprise Server, Ubuntu, Debian, Sun Solaris, IBM AIX, Microsoft Windows 2003 Server, Bash/Shell, Perl, PHP, SQL, Javascript, resume, LaTeX, Python, Jinja2}
}
...
\fancyfoot[L]{\small \textcolor{gray}{Updated on \textsc{\today} using Python and \LaTeX.}}
