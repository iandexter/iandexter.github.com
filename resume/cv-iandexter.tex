...
\begin{center}\begin{spacing}{1}\small
  +63 917 887 6260~\textbullet~
  \href{mailto:im@iandexter.net}{im@iandexter.net}~\textbullet~
...
\begin{section}*{Overview}
  ...
  \begin{subsection}*{Qualifications}
    \begin{compactitem}
      ...
      \item \textbf{Red Hat Certified Engineer}, \textsc{October 2008}
...
\begin{section}*{Experience}
  \begin{subsection}*{Linux system administrator \hfill\textsc{April 2010 to present}}
    ...
    \begin{compactitem}
      ...
      \item Re-factored a service that routes SMS acknowledgements for Nagios alerts. The previous service was not capable of accepting alert acknowledgements through SMS. The new service resulted in higher response times from different operations teams when acting on service alerts.
      \item Writes Nagios plugins and scripts for a monitoring dashboard. The dashboard, used by analysts for a critical business application, provides a single interface for tracking message workflows across various platforms.
