...
\begin{section}*{Other information}
  \begin{inparadesc}
    ...
    \item DevOps,
    \item PaaS, IaaS,
    \item OpenShift, OpenStack, Google App Engine, Amazon Web Services
  \end{inparadesc}
  \vspace{1em}
